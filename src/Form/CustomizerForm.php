...
namespace Drupal\customizer\Form;

use Drupal\customizer\CustomizerInterface;
...
class CustomizerForm extends ConfigFormBase {
   ...
   *   The redirect destination.
   * @param \Drupal\customizer\CustomizerInterface $customizer
   *   The theme customizer.
   */
  ...
  public function buildForm(array $form, FormStateInterface $form_state, $theme = NULL) {
    ...
    $form['#attached']['library'][] = 'customizer/form';
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    ...
    $this->configFactory->getEditable('customizer.theme.' . $theme)
